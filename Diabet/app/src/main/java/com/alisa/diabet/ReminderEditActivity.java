...
public class ReminderEditActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {
    ...
    public void updateReminder() {
        ...
        Toast.makeText(getApplicationContext(), "Отредактировано успешно", Toast.LENGTH_SHORT).show();
        onBackPressed();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.discard_reminder:
                Toast.makeText(getApplicationContext(), "Изменения отменены", Toast.LENGTH_SHORT).show();
