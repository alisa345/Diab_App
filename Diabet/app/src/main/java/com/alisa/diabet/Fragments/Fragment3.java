...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        android.support.design.widget.FloatingActionButton buttonAddReminders = v.findViewById(R.id.add_remind);
        buttonAddReminders.setOnClickListener(new View.OnClickListener() {
            @Override
   ...
   /*     rb = new ReminderDatabase(getActivity());
        mList = v.findViewById(R.id.reminder_list);
        ...
        public class VerticalItemHolder extends SwappingHolder implements View.OnClickListener, View.OnLongClickListener {
            ...
            public void setReminderRepeatInfo(String repeat, String repeatNo, String repeatType) {
                if (repeat.equals("true")) {
                    mRepeatInfoText.setText("Каждый " + repeatNo + " " + repeatType);
                } else if (repeat.equals("false")) {
                    mRepeatInfoText.setText("Повторение выключено");
                }
            }
